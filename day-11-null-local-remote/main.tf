...
#   key_name   = "manasa-tf-key-1"  # Replace with your desired key name
#   public_key = file("~/.ssh/id_rsa.pub")
# }

resource "aws_key_pair" "example" {
  key_name   = "manasa-tf-key-2"
   public_key = file("C:/Users/mi/.ssh/id_ed25519.pub")
    ...
    Statement = [
      {
        ...
        Effect   = "Allow"
        Resource = [
          "arn:aws:s3:::manasadevopsbuckets",
          "arn:aws:s3:::manasadevopsbuckets/*"
        ]
      }
    ]
...
resource "null_resource" "setup_and_upload" {
  ...
  provisioner "remote-exec" {
    inline = [
      ...
      "echo '<h1>Welcome to My devops</h1>' | sudo tee /var/www/html/index.html",

      # Upload the file to S3
      "aws s3 cp /var/www/html/index.html s3://manasadevopsbuckets/",
  ...
  connection {
    type        = "ssh"
    user        = "ec2-user"
     private_key = file("C:/Users/mi/.ssh/id_ed25519") 
